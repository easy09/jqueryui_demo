...
?>
<fieldset>
<legend>下载文件发布</legend>
<ul class="sl-table">
    <li><label>文件标题</label><input type="text" name="title" class="required"></li>
    <li><label>界面截图(必须小于1M)</label><input type="file" name="image"></li>
    <li><label>上传文件(必须小于1M)</label><input type="file" name="file"></li>
    <li><label>分类</label>
        <select name="title">
